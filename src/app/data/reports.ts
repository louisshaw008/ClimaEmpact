export interface Report {
  ...
  location: string;
  summary: string;
  impactLevel: string; // e.g., "Critical", "Severe", "High"
  imageUrl: string;
...
export const reports: Report[] = [
  {
    ...
    summary: 'Hurricane Beryl became the earliest Category 5 Atlantic hurricane on record in late June 2024, fueled by exceptionally warm sea surface temperatures. It devastated Carriacou, Grenada, and other Caribbean islands before making landfall in Texas. Wind speeds reached 270 km/h, destroying over 90% of structures on some islands. At least 11 people were killed across the Caribbean and the storm caused widespread power outages in Texas. With sea surface temperatures 1–2°C above the historical average, Beryl\'s rapid intensification exemplifies how warming oceans amplify hurricane destructive potential and coastal community exposure.',
